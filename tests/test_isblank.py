...
class TestUnderACoarserGrain:
    def test_a_coarser_grain_refuses_rather_than_inventing_a_number(self):
        ...
        # back from a quarterly projection as [1, 2] — the truth series
        # SUMMED, a count of blanks wearing a boolean's name. Refusing
        # is the honest answer: the author is told to declare what a
        # quarter of "was it empty?" means.
