...
"""The blend spec — ``mo.blend`` inside the tracks declaration.
...
UNCHANGED — data lines splice their givens, memoryless lines coincide
with the output splice, stateful lines (recurrence / cumsum / lag)
